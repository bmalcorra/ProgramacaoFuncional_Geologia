...
2. Faça um gráfico de barras dos elementos químicos. Agrupe por litho e adicione barras de erro.
  - Dica: utilize as funções pivot_longer() e facet_wrap().
...
---
# 6. qual a correlação entre distância até o sill e os elementos químicos nas rochas SEDIMENTARES?
